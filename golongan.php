    ...
    <body>
        ...
        <table class="table table-striped table-dark" style="margin-top: 30px;" >
            ...
            <tr>
                ...
                <td><?php echo $formulir["tj_keluarga"];?></td>
                <td><?php echo $formulir["tj_transportasi"];?></td>
                <td><?php echo $formulir["tj_makan"];?></td>

                <td> 
                    <a  href="edit3.php?gol=<?php echo $formulir["gol"]; ?>" class="text-reset btn btn-primary">EDIT</a>
                    <a href="hapus3.php?gol=<?php echo $formulir["gol"]; ?>" onclick=" return confirm('yakin data akan di apus?');" class="text-reset btn btn-warning">HAPUS
                </td>
            </tr>
            <?php   $i++; ?>   
            <?php endwhile; ?>     
