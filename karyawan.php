...
<html>
    ...
    <body>
        ...
        <table class="table table-striped table-dark" style="margin-top: 30px;">
            ...
            <tr>
                <td><?php echo $i;?></td>
                <td><?php echo $formulir["nip"];?></td>
                <td><?php echo $formulir["nama"];?></td>
                <td><?php echo $formulir["alamat"];?></td>
                <td><?php echo $formulir["kota"];?></td>
                <td><?php echo $formulir["jk"];?></td>
                <td><?php echo $formulir["nama_jabatan"];?></td>
                <td><?php echo $formulir["gol"];?></td>

                <td> 
                    <a href="edit1.php?nip=<?php echo $formulir["nip"]; ?>" class="text-reset btn btn-primary">|EDIT|</a>
                    <a href="hapus1.php?nip=<?php echo $formulir["nip"]; ?>" onclick=" return confirm('yakin data akan di apus?');" class="text-reset btn btn-warning">HAPUS|
                </td>
            </tr>
            <?php   $i++; ?>   
            <?php endwhile; ?>     
