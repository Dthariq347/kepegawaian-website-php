...
<html>
    ...
    <body>
       <!-- navbar -->
        ...
        <!-- keluaran hasil dari index2.php -->
        <table class="table table-striped table-dark" style=" margin-top: 30px;" >
            ...
            <tr>
                <td><?php echo $i;?></td>
                <td><?php echo $formulir["kd_jabatan"];?></td>
                <td><?php echo $formulir["nama_jabatan"];?></td>
                <td><?php echo $formulir["tunjangan_jabatan"];?></td>

                <td> 
                    <a href="edit2.php?kd_jabatan=<?php echo $formulir['kd_jabatan']; ?>" class="text-reset btn btn-primary">|EDIT|</a>
                    <a href="hapus2.php?kd_jabatan=<?php echo $formulir['kd_jabatan']; ?>" onclick=" return confirm('yakin data akan di apus?');" class="text-reset btn btn-warning">HAPUS|
                </td>
            </tr>
            <?php   $i++; ?>   
            <?php endwhile; ?>     
