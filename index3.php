        ...
        <form action="" method="POST" autocomplete="off">
            <div style="margin-left: 25px; margin-right: 25px; margin-top: 30px;" ><br><br>
                ...
                <div>
                    ...
                    <input type="text" name="gol" id="gol" class="form-control" placeholder="jurusan" required>
                </div>
                <br>
                <!-- nama_jabatan  -->
                <div>
                    <label for="tj_keluarga" class="form-label">Tunjangan keluarga :</label>
                    <input type="text" name="tj_keluarga" id="tj_keluarga" class="form-control" placeholder="Tunjangan keluarga">
                </div>
                <br>
                 <!-- Tunjangan  -->
                <div>
                    <label for="tj_transportasi" class="form-label">Tunjangan transportasi :</label>
                    <input type="text" name="tj_transportasi" id="tj_transportasi" class="form-control" placeholder="Tunjangan transportasi">
                </div>
                <br>
                <!-- Tunjangan  -->
                <div>
                    <label for="tj_makan" class="form-label">Tunjangan makan :</label>
                    <input type="text" name="tj_makan" id="tj_makan" class="form-control" placeholder="Tunjangan makan">
                </div>
                <br>
                <!-- submit -->
                <div class="col-12" >
